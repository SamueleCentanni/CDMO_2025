...
class STS_Optimized_LightModel_NoSB:
    ...
    def solve(self, timeout_seconds, random_seed=None, verbose=False, solver_options=True):
        ...
        while True:
            ...
            if optimal_objective_value is not None:
                ...
                if verbose:
                    print(f"  Looking for solution with total_diff < {optimal_objective_value} (Remaining time: {remaining_time}s)...")
            else:
                if verbose:
            ...
            if status == sat:
                ...
                if optimal_objective_value is None or current_objective < optimal_objective_value:
                    ...
                    if optimal_objective_value == 1:
                        ...
                        if verbose:
                            print("    Lower bound reached. Optimal solution found.")
                        self.solver.pop()
                        break
