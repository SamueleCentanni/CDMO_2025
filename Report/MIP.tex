...
\begin{table}[H]
    ...
    \text{\small{Efficiency constraints off. Results with $time=0$ or $time=300$ were not considered}}
    \label{tab:mip1}
\end{table}
...
\begin{table}[H]
    ...
    \text{\small{Efficiency constraints on. Results with $time=0$ or $time=300$ were not considered}}
    \label{tab:mip2} 
\end{table}